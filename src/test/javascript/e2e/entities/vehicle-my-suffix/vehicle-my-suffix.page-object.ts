...
export class VehicleDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('maxApp.vehicle.delete.question'));
...
export default class VehicleComponentsPage {
  ...
  title: ElementFinder = element(by.id('vehicle-my-suffix-heading'));
  ...
  async goToPage(navBarPage: NavBarPage) {
    await navBarPage.getEntityPage('vehicle-my-suffix');
  ...
  async deleteVehicle() {
    ...
    expect(await vehicleDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/maxApp.vehicle.delete.question/);
