...
import LocationUpdatePage from './location-my-suffix-update.page-object';

const expect = chai.expect;
export class LocationDeleteDialog {
  deleteModal = element(by.className('modal'));
  private dialogTitle: ElementFinder = element(by.id('maxApp.location.delete.question'));
...
export default class LocationComponentsPage {
  ...
  title: ElementFinder = element(by.id('location-my-suffix-heading'));
  ...
  async goToPage(navBarPage: NavBarPage) {
    await navBarPage.getEntityPage('location-my-suffix');
  ...
  async deleteLocation() {
    ...
    expect(await locationDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/maxApp.location.delete.question/);
